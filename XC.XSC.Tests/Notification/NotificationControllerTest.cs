...
namespace XC.XSC.Tests.Notification
{
    [TestClass]
    public class NotificationControllerTest
    {
        ...
        public void TestInitialize()
        {
            ...
            _notificationController =new NotificationController(_notificationService,_response);
        }
        ...
        [TestMethod]
        public async Task GetUserNotification_Success()
        {
            _response = await _notificationController.GetUserNotification();
            if (_response == null)
            {
        ...
        [TestMethod]
        [DataRow(1)]
        public async Task UpdateNotificationsStatus_Success(int id)
        {
            _response = await _notificationController.UpdateNotificationsStatus(id);
            if (_response == null)
            {
                Assert.IsNull(_response);
            }
        ...
        [TestMethod]
        [DataRow(0)]
        public async Task UpdateNotificationsStatus_Return_False(int id)
        {
            _response = await _notificationController.UpdateNotificationsStatus(id);
            if (_response == null)
            {
        ...
        [TestMethod]
        [DataRow(2)]
        public async Task UpdateNotificationsStatus_Return_False_When_Notification_NotExist(int id)
        {
            _response = await _notificationController.UpdateNotificationsStatus(id);
            if (_response == null)
            {
